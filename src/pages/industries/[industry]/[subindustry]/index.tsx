...
const SubIndustry: FunctionComponent<SubIndustryProps> = ({ layout, meta }) => {
  return (
    <>
...
export const getStaticPaths: GetStaticPaths = async (ctx) => {
  ...
  const paths = response?.data
    .map((item: any) => {
      ...
      if (parent)
        return {
          params: { industry: parent, subindustry: item.attributes.slug },
        }
    })
